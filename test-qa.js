...
(async () => {
  ...
  await page.click('button:has-text("Extract & Plan")').catch(() => console.log("Extract button not found"));
  ...
  const successLoad = await page.locator('text=Example Domain').isVisible().catch(() => false);
  if (successLoad) {
    console.log("Extraction successful.");
  } else {
    console.log("Extraction failed or UI did not update.");
  }
